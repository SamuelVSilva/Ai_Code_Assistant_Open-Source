...
title Build AI Code Assistant v0.4.11 - Windows

echo ===============================================================
echo    AI Code Assistant - Build para Windows
echo    Versao: v0.4.11-rev1.2.17-s64-060526 ^| homologacao
...
REM Verificacao explicita de dependencias criticas
%PY_BUILD% -c "import PyQt6; import requests; print('[OK] PyQt6 e requests verificados')"
if %errorlevel% neq 0 (
    echo [ERRO CRITICO] PyQt6 ou requests nao encontrados no ambiente!
    echo Verifique se voce esta no ambiente Python correto.
    echo Tente: pip install PyQt6 requests
    pause
    exit /b 1
)
...
if exist "%OUTPUT_DIR%\%APP_NAME%_v%VERSION%.exe" (
    ...
    echo v%VERSION%-rev%REV%-%BUILD_DATE% | homologacao > %OUTPUT_DIR%\VERSION.txt
    ...
    echo Versao: v%VERSION%-rev%REV%-%BUILD_DATE%
    echo ===============================================================
    echo.
) else (
    echo ===============================================================
